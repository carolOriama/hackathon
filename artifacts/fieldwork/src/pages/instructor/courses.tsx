...
import { Users, TicketCheck, Star, Building2 } from "lucide-react";
import { InstructorLayout } from "@/components/layout/instructor-layout";
import { Card, CardContent } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { Progress } from "@/components/ui/progress";
import { instructorCourses } from "@/lib/instructor-data";
                ...
                <CardContent className="p-6 md:p-8">
                  ...
                  {course.status === "Draft" && (
                    <div className="mt-6 p-4 bg-slate-50 rounded-xl border border-slate-100 text-sm text-slate-500">
                      This course is in draft. Add sprints and tickets, then submit for admin review to go live.
                    </div>
                  )}
                </CardContent>
              </Card>
